...
public class AuctionDTO implements ValidatableDTO {
    ...
    public AuctionDTO(
        ...
        this(id, item, seller, winner, currentHighestBid, currentPrice, title, description,
                startTime, endTime, null, null, status, antiSnipingWindowSeconds, antiSnipingExtensionSeconds,
    ...
    public AuctionDTO(
            ...
            boolean currentUserDeposited) {
        this(id, item, seller, winner, currentHighestBid, currentPrice, title, description,
                startTime, endTime, paymentDeadlineAt, null, status, antiSnipingWindowSeconds,
                antiSnipingExtensionSeconds, depositAmount, currentUserDeposited);
    }
