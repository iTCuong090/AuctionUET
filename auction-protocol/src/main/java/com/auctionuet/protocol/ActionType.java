...
public enum ActionType {
    ...
    CREATE_ITEM, UPDATE_ITEM, DELETE_ITEM, GET_MY_ITEMS, GET_ITEM_AUCTION_HISTORY,
    ...
    // Admin (tuần 5)
    GET_ALL_USERS, DELETE_USER, UPDATE_ROLE, UPDATE_USER_STATUS,

    // Wallet (tuần 5)
    DEPOSIT, WITHDRAW, GET_WALLET, GET_MY_TRANSACTIONS,

    // Payment (tuần 5)
    PAY_AUCTION, GET_MY_PENDING_PAYMENTS
}
